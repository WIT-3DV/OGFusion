...
class GlobalTraversalConstructor:
    ...
    def shape_to_reference_points(
        self,
        H: Union[torch.Tensor, Number],
        W: Union[torch.Tensor, Number],
        lH: Union[torch.Tensor, Number],
        lW: Union[torch.Tensor, Number],
    ):
