...
# NOTE: Removed GroupDeformableDetrTransformerDecoderLayer due to missing GroupMultiheadAttention dependency
# @MODELS.register_module()
...
class BEVFormerLayerV3(CustomBaseTransformerLayer):
    ...
    def check_attn_masks(
        self, attn_masks: Optional[Union[torch.Tensor, List[Optional[torch.Tensor]]]]
