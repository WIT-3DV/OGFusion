...
class DDNTemplate(nn.Module):
    ...
    def __init__(self, constructor, num_classes, feat_extract_layer='', pretrained_path=None, aux_loss=None,
    ...
    def forward(self, images):
        ...
        if isinstance(self.feat_extract_layer, list):
            ...
            for index, feature_name in enumerate(
                    self.feat_extract_layer):  # [B, 256, 129, 484] [B, 512, 65, 242] [B, 1024, 65, 242] [B, 2048, 65, 242]
